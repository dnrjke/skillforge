# Skillforge — Development Constitution

> **Skillforge는 '잘 만드는 게임'이 아니라 '설계하고 감상하는 게임'을 만든다.**
...
Skillforge는 **반응형(Responsive)이 아닌 적응형(Adaptive) 레이아웃**을 사용한다.
...
- **Layers:** L0(Canvas 전장), L1(시나리오/천사상), L2(시스템 UI)
